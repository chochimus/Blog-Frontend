const About = () => {
  return (
    <div className="flex flex-col items-center mx-4 sm:mx-auto max-w-xl">
      <h1 className="text-5xl font-bold text-gray-900 text-center my-8">
        About me
      </h1>
      <ul className="text-center space-y-8">
        ...
        <li>
          <figure className="relative w-full max-w-sm mx-auto transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
            <img
              className="h-auto w-full rounded-lg "
              src="https://images.pexels.com/photos/406014/pexels-photo-406014.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            ></img>
            <figcaption className="absolute px-4 text-sm sm:text-base text-white bottom-4 left-14">
              <p>I also enjoy front-end design!</p>
            </figcaption>
          </figure>
        </li>
        <li>
        ...
        <li>
          <div className="flex justify-center gap-5">
            <svg
              className="hover:fill-gray-600 fill-gray-900"
